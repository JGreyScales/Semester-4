...
BEGIN {
    ...
    require 'D:/Programming/Semester-4/Mobile and networked systems/week4/Crow_test/vcpkg_installed/vcpkg/blds/openssl/x64-windows-rel/util/perl/OpenSSL/Util.pm';
    OpenSSL::Util->import();
}
...
if ($ARGV[0] eq '-fips') {
    $std_openssl_conf = 'D:/Programming/Semester-4/Mobile and networked systems/week4/Crow_test/vcpkg_installed/vcpkg/blds/openssl/x64-windows-rel/test/fips-and-base.cnf';
    shift;
